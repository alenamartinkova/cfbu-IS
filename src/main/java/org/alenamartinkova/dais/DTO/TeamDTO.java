...
import org.alenamartinkova.dais.business.Team;
...
public class TeamDTO {
    ...
    public Team toBO() {
        return new Team(this.teamid, this.leagueID, this.name, this.rank, this.covid, this.quarantinedFrom == null?null: this.quarantinedFrom.toString());
    }
}
