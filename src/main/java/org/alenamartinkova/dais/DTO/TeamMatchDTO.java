...
import org.alenamartinkova.dais.business.TeamMatch;
...
public class TeamMatchDTO {
    ...
    public TeamMatch toBO() {
        return new TeamMatch(this.teamMatchID, this.matchID, this.firstTeamID, this.secondTeamID, this.firstRefereeID, this.secondRefereeID, this.firstTeamGoals, this.secondTeamGoals);
    }
